...
func (c *helloWorldClient) Echo(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	out := new(StringMessage)
	err := c.cc.Invoke(ctx, "/your.service.v1.HelloWorld/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloWorldServer) Echo(context.Context, *StringMessage) (*StringMessage, error) {
...
func _HelloWorld_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/your.service.v1.HelloWorld/Echo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).Echo(ctx, req.(*StringMessage))
	}
...
var HelloWorld_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "your.service.v1.HelloWorld",
